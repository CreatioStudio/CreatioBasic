...
public class PacketByteBuf extends ByteBuf implements Wrapper<PacketDataSerializer> {

    private final PacketDataSerializer buf;

    PacketByteBuf(PacketDataSerializer nms) {
        this.buf = nms;
    }

    public PacketByteBuf(ByteBuf buf) {
        this.buf = new PacketDataSerializer(buf);
    }

    public PacketByteBuf(int init) {
        this.buf = new PacketDataSerializer(Unpooled.buffer(init));
    }

    public PacketByteBuf(int init, int max) {
        this.buf = new PacketDataSerializer(Unpooled.buffer(init, max));
    }
    ...
    public PacketByteBuf writeByteArray(byte[] arr) {
        buf.a /* writeByteArray */ (arr);
        return this;
    }

    public byte[] readByteArray() {
        return buf.a /* readByteArray */ ();
    }

    public byte[] readByteArray(int index) {
        return buf.b /* readByteArray */ (index);
    }

    public PacketByteBuf writeVarIntArray(int[] arr) {
        buf.a /* writeVarIntArray */ (arr);
        return this;
    }

    public int[] readVarIntArray() {
        return buf.b /* readVarIntArray */ ();
    }

    public int[] readVarIntArray(int index) {
        return buf.c /* readVarIntArray */ (index);
    }

    public PacketByteBuf writeLongArray(long[] arr) {
        buf.a /* writeLongArray */ (arr);
        return this;
    }

    public Vec3i readBlockPos() {
        return Vec3i.of(readLong());
    }

    public PacketByteBuf writeBlockPos(Vec3i vec) {
        writeLong(vec.asLong());
        return this;
    }

    public Component readComponent() {
        return Component.fromJson(readUtf(262144));
    }

    public PacketByteBuf writeComponent(Component comp) {
        return writeUtf(comp.toJson(), 262144);
    }
    ...
    public PacketByteBuf writeEnum(Enum<?> e) {
    ...
    public int readVarInt() {
        return buf.i /* readVarInt */ ();
    }

    public long readVarLong() {
        return buf.j /* readVarLong */ ();
    }

    public PacketByteBuf writeVarInt(int var) {
        buf.d /* writeVarInt */ (var);
        return this;
    }

    public PacketByteBuf writeVarLong(long var) {
        buf.b /* writeVarLong */ (var);
        return this;
    }

    public String readUtf(int maxChars) {
        return buf.e /* readUtf */ (maxChars);
    }

    public PacketByteBuf writeUtf(String content) {
        return writeUtf(content, 32767);
    }

    public PacketByteBuf writeUtf(String content, int maxBytes) {
        buf.a /* writeUtf */ (content, maxBytes);
        return this;
    }
    ...
    @Override
    public PacketDataSerializer unwrap() {
        return buf;
    }

    @Override
    public Class<? extends PacketDataSerializer> wrappedClass() {
        return buf.getClass();
    }
    ...
    @Override
    public int hashCode() {
        return buf.hashCode() * 31;
    }

    @Override
    public boolean equals(Object o) {
        if (o instanceof PacketByteBuf) {
            return buf.equals(((PacketByteBuf) o).buf);
        }
        return false;
    }
